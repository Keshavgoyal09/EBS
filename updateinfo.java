...
public class updateinfo extends JFrame implements ActionListener {
    ...
    JTextField tfcity, tfstate, tfemail, tfphone, tfaddress;
       ...
       try{
            ...
            while(rs.next()){
                name.setText(rs.getString("name"));
                  ...
                  tfstate.setText(rs.getString("city"));
    ...
    public void actionPerformed(ActionEvent ae){
         if(ae.getSource()== Update){
            ...
            try{
                Conn c = new Conn();
                c.s.executeUpdate("Update Customer set address = '"+address+"', city = '"+city+"', state = '"+state+"', email = '"+email+"', phn = '"+phone+"' where meter = '"+meter+"'");
                JOptionPane.showConfirmDialog(null, "Successfully Update Information");
                setVisible(false);
            }catch(Exception e){
                e.printStackTrace();
            }
